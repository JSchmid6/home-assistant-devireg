...
from pysdg.gen.tabddpm.gen_multi_report import gen_multi_report
from pysdg.gen.tabddpm.pipeline_modules import *
from pysdg.gen.tabddpm.pipeline_utils import *
from pysdg.gen.tabddpm.tab_ddpm.utils import *
    ...
    if os.path.exists(os.path.join(save_dir, "cluster_ckpt.pkl")):
        ...
        for parent, child in relation_order_reversed:
            if parent is not None:
                ...
                ) # SMK - this is the function that is used for clustering which returns the updated dataframes with cluster information
...
def clava_training(tables, relation_order, save_dir, configs, pysdg_device_name): # SMK - this function is used to train the models. Start digging here.
    models = {}
    for parent, child in relation_order:
        ...
        result = child_training(
            df_without_id, tables[child]["domain"], parent, child, configs, pysdg_device_name
        ) # SMK - This is the training function
